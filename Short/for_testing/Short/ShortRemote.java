...
/**
 * The <code>ShortRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  C:\\Users\\Julius Gruber\\Dropbox\\Master\\matlab\\functions\\shortFunction.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>ShortRemote</code> 
 ...
 * generate RMI server proxy objects for instances of Short.Short.
 */
public interface ShortRemote extends Poolable
{
    /**
     ...
     */
    public Object[] shortFunction(int nargout, Object... rhs) throws RemoteException;
