...
for k= 1: length(fileInfoArrayWAVonly)
    ...
    featureVector(1,1) = ALLDESC_s.TEE.Att;
    featureVector(1,2) = ALLDESC_s.TEE.Dec;
    featureVector(1,3) = ALLDESC_s.TEE.Rel;
    featureVector(1,4) = ALLDESC_s.TEE.LAT;
    featureVector(1,5) =  ALLDESC_s.TEE.AttSlope;
    featureVector(1,6) = ALLDESC_s.TEE.DecSlope;
    featureVector(1,7) = ALLDESC_s.TEE.TempCent;
    featureVector(1,8) = ALLDESC_s.TEE.EffDur;
    featureVector(1,9) = ALLDESC_s.TEE.FreqMod;
    featureVector(1,10) = ALLDESC_s.TEE.AmpMod;
     ...
     featureVector(1,23) =ALLDESCSTATS_s.AS_median.ZcrRate;
     ...
     featureVector(1,36) =ALLDESCSTATS_s.AS_iqr_normal.ZcrRate;
     ...
     featureVector(1,50) =ALLDESCSTATS_s.ERBgam_median.SpecCent;
     featureVector(1,51) =ALLDESCSTATS_s.ERBgam_median.SpecSpread;
     featureVector(1,52) =ALLDESCSTATS_s.ERBgam_median.SpecSkew;
     featureVector(1,53) =ALLDESCSTATS_s.ERBgam_median.SpecKurt;
     featureVector(1,54) =ALLDESCSTATS_s.ERBgam_median.SpecSlope; 
     featureVector(1,55) =ALLDESCSTATS_s.ERBgam_median.SpecDecr;
     featureVector(1,56) =ALLDESCSTATS_s.ERBgam_median.SpecRollOff;
     featureVector(1,57) =ALLDESCSTATS_s.ERBgam_median.SpecVar;
     featureVector(1,58) =ALLDESCSTATS_s.ERBgam_median.FrameErg;
     featureVector(1,59) =ALLDESCSTATS_s.ERBgam_median.SpecFlat;
     featureVector(1,60) =ALLDESCSTATS_s.ERBgam_median.SpecCrest;
    
     featureVector(1,61) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecCent;
     featureVector(1,62) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecSpread;
     featureVector(1,63) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecSkew;
     featureVector(1,64) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecKurt;
     featureVector(1,65) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecSlope;
     featureVector(1,66) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecDecr;
     featureVector(1,67) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecRollOff; 
     featureVector(1,68) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecVar;
     featureVector(1,69) =ALLDESCSTATS_s.ERBgam_iqr_normal.FrameErg; 
     featureVector(1,70) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecFlat; 
     featureVector(1,71) =ALLDESCSTATS_s.ERBgam_iqr_normal.SpecCrest;
    
     featureVector(1,72) =ALLDESCSTATS_s.ERBgam_mean.SpecCent;
     featureVector(1,73) =ALLDESCSTATS_s.ERBgam_mean.SpecSpread;
     featureVector(1,74) =ALLDESCSTATS_s.ERBgam_mean.SpecSkew;
     featureVector(1,75) =ALLDESCSTATS_s.ERBgam_mean.SpecKurt;
     featureVector(1,76) =ALLDESCSTATS_s.ERBgam_mean.SpecSlope;
     featureVector(1,77) =ALLDESCSTATS_s.ERBgam_mean.SpecDecr;
     featureVector(1,78) =ALLDESCSTATS_s.ERBgam_mean.SpecRollOff;
     featureVector(1,79) =ALLDESCSTATS_s.ERBgam_mean.SpecVar;
     featureVector(1,80) =ALLDESCSTATS_s.ERBgam_mean.FrameErg;
     featureVector(1,81) =ALLDESCSTATS_s.ERBgam_mean.SpecFlat;
     featureVector(1,82) =ALLDESCSTATS_s.ERBgam_mean.SpecCrest;
...
% run t-SNE
mappedX = tsne(nxdNorm, [], no_dims, initial_dims, perplexity);

% plot results
figure();
gscatter(mappedX(:,1), mappedX(:,2));

TimbreToolboxViewPortTransformAndCreateTXTfile(mappedX, fileInfoArrayWAVonly, 'TeeERBgam', dirName);
