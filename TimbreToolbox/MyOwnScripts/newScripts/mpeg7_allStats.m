...
% set t-SNE Paramters, this feature set has 7 features
no_dims = 2;
initial_dims = 7;
perplexity =5;

viewName = 'TT_mpeg7_allStats';
...
%             %%%%%%%%%%%%%%% add TEMPORAL ENRERGY ENVELOPE FEATURES %%%%%%%%%%%%%%%%%%%%%%%
            ...
            featureVector(1,end+1) = ALLDESCSTATS_s.TEE_median.TempCent;
            featureVector(1,end+1) = ALLDESCSTATS_s.TEE_iqr.TempCent;
