function   TimbreToolboxViewPortTransformAndCreateTXTfile( mappedX, fileInformationArray, fileName, sampleFolderPath )
...
fopenString = strcat(sampleFolderPath,fileName,'.txt')
