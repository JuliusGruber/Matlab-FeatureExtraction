...
%     %%%%%%%%%%%%%%%% add Features here %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecCent;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecSpread;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecSkew; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecKurt;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecSlope;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecDecr;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecRollOff; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecVar;
    featureVector(1,end+1) = ALLDESCSTATS_s.ERBgam_median.FrameErg; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecFlat;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_median.SpecCrest;
    
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecCent;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecSpread; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecSkew; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecKurt; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecSlope; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecDecr; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecRollOff; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecVar;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.FrameErg;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecFlat;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_iqr.SpecCrest;
    
    
    
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecCent;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecSpread;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecSkew; 
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecKurt;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecSlope;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecDecr;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecRollOff;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecVar;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.FrameErg;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecFlat;
    featureVector(1,end+1) =ALLDESCSTATS_s.ERBgam_mean.SpecCrest;   
