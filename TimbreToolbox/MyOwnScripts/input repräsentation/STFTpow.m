...
%     %%%%%%%%%%%%%%%% add Features here %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecSpread;
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecSkew; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecKurt;
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecSlope;
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecDecr;
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecRollOff; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecVar;
    featureVector(1,end+1) = ALLDESCSTATS_s.STFTpow_median.FrameErg; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_median.SpecFlat;
    ...
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_iqr.SpecSkew; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_iqr.SpecKurt; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_iqr.SpecSlope; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_iqr.SpecDecr; 
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_iqr.SpecRollOff; 
    ...
    featureVector(1,end+1) =ALLDESCSTATS_s.STFTpow_iqr.SpecCrest;
