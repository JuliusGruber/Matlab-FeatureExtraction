...
%%%%%%%  T - SNE %%%%%%%%%%%%%%%%%%%%%%%%%%%
% set Paramters, this feature set has 13 features
no_dims = 2;
initial_dims = 13;
perplexity = 5;

viewName = 'MIR_mfcc_mw';
...
% essentiaViewPortTransformAndCreateTXTfile(mappedX, fileInformationArray, 'MFCC_mean', dirName);
