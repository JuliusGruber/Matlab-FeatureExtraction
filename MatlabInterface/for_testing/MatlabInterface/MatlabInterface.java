 ...
 *  C:\\Users\\Julius Gruber\\Dropbox\\Master\\matlab\\functions\\getAllFileNames.m
 * </pre>
...
public class MatlabInterface extends MWComponentInstance<MatlabInterface>
{
    ...
    private static final MWFunctionSignature sFeAndDimensionReduction3Signature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                ...
                                /* has varargin = */ false);
    /**
     * Maintains information used in calling the <code>getAllFileNames</code> M-function.
     */
    private static final MWFunctionSignature sGetAllFileNamesSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "getAllFileNames",
                                /* max inputs = */ 1,
                                /* has varargin = */ false);
    ...
    {
        this(MatlabInterfaceMCRFactory.newInstance());
    }
    ...
    {
        this(MatlabInterfaceMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MatlabInterfaceMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MatlabInterfaceMCRFactory.newInstance();
    ...
    /**
     * Provides the interface for calling the <code>getAllFileNames</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void getAllFileNames(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sGetAllFileNamesSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void getAllFileNames(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sGetAllFileNamesSignature);
    }

    /**
     * Provides the standard interface for calling the <code>getAllFileNames</code>
     * M-function with 1 input argument.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] getAllFileNames(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sGetAllFileNamesSignature), 
                    sGetAllFileNamesSignature);
        return lhs;
    }
}
