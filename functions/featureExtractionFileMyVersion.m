function [midFeatures, Centers, stFeaturesPerSegment] = ...
    featureExtractionFileMyVersion(fileName, stWin, stStep, mtWin, mtStep, featureStatistics)
...
readBlockSize = 10; % one minute block size
...
%     Features = stFeatureExtraction(tempX, fs, stWin, stStep);
    Features = stFeatureExtractionMFCCsOnly(tempX, fs, stWin, stStep);
