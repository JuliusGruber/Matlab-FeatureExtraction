function idFilePath = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   IDFILEPATH = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   IDFILEPATH = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   idFilePath = importfile('idFilePath.txt', 1, 948);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/06/13 16:47:59
