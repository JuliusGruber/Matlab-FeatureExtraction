function  viewPortTransformAndCreateViewMatFile( mappedX, fileInformationArray, fileName, sampleFolderPath  )
%VIEWPORTTRANSFORMANDCREATEVIEWMATFILE Summary of this function goes here
...
for i = 1 : size(mappedXtransformed,1)
   ...
   viewData{i,1} = xFile;
   viewData{i,2} = yFile;
   viewData{i,3}= pathOfFile;
   viewData{i,4} = nameOfFile;
end

catFileName = strcat('view',fileName);

save([sampleFolderPath catFileName ], 'viewData');
